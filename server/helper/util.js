 ...
 sendMailOtpNodeMailer: async (email, otp, firstName) => {
    try {
      ...
      * {
      ...
      <p style="font-size: 14px; line-height: 140%;">Welcome to  <b> Hexaverse Education. </b> Your Email One Time Password (OTP) to log in to your Hexaverse Education account is <b>${otp}</b>.The OTP is valid for 5 minutes. This OTP will be used to verify the device you are logging in from. For account safety, Do not share your OTP with others.</p></br>
     <p>Thanks and Regards, <br>
  <b>Team Hexaverse Education </b></p> 
        </div>
      ...
      <table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
        ...
        <div style="color: #ffffff; line-height: 150%; text-align: center; word-wrap: break-word;">
          <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 14px; line-height: 19.6px;">2022 @ | Hexaverse Education | All Rights Reserved</span></p>
        </div>
